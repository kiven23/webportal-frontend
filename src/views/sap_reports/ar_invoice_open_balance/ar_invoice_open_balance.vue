...
export default {
  ...
  methods: {
    printpre(){
        ...
        this.iden = 0; 
        this.printLink = 'http://10.10.10.38:9999/api/public/reports/queries/arinvoiceopenbalance?q=printing&series='+this.branch.U_Branch1+'';
        fetch('http://10.10.10.38:9999/api/public/reports/queries/arinvoiceopenbalance?q=printing&&series='+this.branch.U_Branch1+'').then((res)=>{
           this.iden = 1; 
        })
      },
