...
export default {
  ...
  methods: {
    printpre(){
        ...
        this.iden = 0; 
        // this.printLink = 'http://192.168.1.19:7771/api/public/reports/queries/marketingarinvoicequery?q=printing&datefrom='+this.dates_regular[0]+'&dateto='+this.dates_regular[1]+'&series='+this.branch.SeriesName+'';
        // fetch('http://192.168.1.19:7771/api/public/reports/queries/marketingarinvoicequery?q=printing&datefrom='+this.dates_regular[0]+'&dateto='+this.dates_regular[1]+'&series='+this.branch.SeriesName+'').then((res)=>{
        //    this.iden = 1; 
           
        // })
        async function getSrc(token, dates_regular1,dates_regular2, series) {
              const res = await fetch('http://192.168.1.19:7771/api/public/reports/queries/marketingarinvoicequery?q=printing&datefrom='+dates_regular1+'&dateto='+dates_regular2+'&series='+series+'', {
              method: 'GET',
              headers: {
