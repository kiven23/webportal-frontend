  ...
  <div>
    <v-container grid-list-md text-xs-center>
      ...
      >
        <template v-slot:top>
          <v-toolbar flat>
            <v-toolbar-title>Adjustment Sales Discount</v-toolbar-title>
    ...
    >
      ...
      <v-card>
        ...
        >
          ...
          <v-toolbar-title style="color: black">Adjustment Sales Discount Print Preview</v-toolbar-title>
          <v-spacer></v-spacer>
...
export default {
  ...
  computed: {
    ...mapGetters({
      query: "adjustment_sales_discount/QUERY",
      permissions: "userPermissions/getPermission",
      branches: "adjustment_sales_discount/getBranchSegment",
  ...
  created() {
    this.$store.dispatch("adjustment_sales_discount/fetchBranchSegment");
  ...
  methods: {
    ...
    generate() {
      ...
      this.$store.dispatch("adjustment_sales_discount/generatequery", data);
    },
    refreshData() {
      let data = {
        date: this.dates_regular,
