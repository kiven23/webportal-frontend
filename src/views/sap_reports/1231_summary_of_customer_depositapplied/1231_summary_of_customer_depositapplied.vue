  ...
  methods: {
    printpre(){
        ...
        async function getSrc(token, dates_regular1,dates_regular2, series) {
              const res = await fetch(''+this.$URLs.backend+'/api/public/reports/queries/summaryofcustomerdepositapplied?q=printing&datefrom='+dates_regular1+'&dateto='+dates_regular2+'&series='+series+'', {
              method: 'GET',
              headers: {
