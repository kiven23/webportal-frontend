  ...
  <div>
    <v-container grid-list-md text-xs-center>
      ...
      >
        <template v-slot:top>
          <v-toolbar flat>
            <v-toolbar-title>Summary of Customer Deposit Applied</v-toolbar-title>
...
export default {
  ...
  methods: {
    printpre(){
        ...
        this.iden = 0; 
        // this.printLink = 'http://192.168.1.19:7771/api/public/reports/queries/summaryofcustomerdepositapplied?q=printing&datefrom='+this.dates_regular[0]+'&dateto='+this.dates_regular[1]+'&series='+this.branch.U_Branch1+'';
        // fetch('http://192.168.1.19:7771/api/public/reports/queries/summaryofcustomerdepositapplied?q=printing&datefrom='+this.dates_regular[0]+'&dateto='+this.dates_regular[1]+'&series='+this.branch.U_Branch1+'').then((res)=>{
        //    this.iden = 1; 
           
        // })
        async function getSrc(token, dates_regular1,dates_regular2, series) {
              const res = await fetch('http://192.168.1.19:7771/api/public/reports/queries/summaryofcustomerdepositapplied?q=printing&datefrom='+dates_regular1+'&dateto='+dates_regular2+'&series='+series+'', {
              method: 'GET',
              headers: {
